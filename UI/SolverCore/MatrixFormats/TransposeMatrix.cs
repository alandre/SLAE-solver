namespace SolverCore
{
        ...
        where T : ITransposeLinearOperator, ILinearOperator
    {
        ...
        public IVector LMult(IVector vector, bool isUseDiagonal, int diagonalElement = 1) => Matrix.LMultTranspose(vector, isUseDiagonal, diagonalElement);
        ...
        public IVector UMult(IVector vector, bool isUseDiagonal, int diagonalElement = 1) => Matrix.UMultTranspose(vector, isUseDiagonal, diagonalElement);
