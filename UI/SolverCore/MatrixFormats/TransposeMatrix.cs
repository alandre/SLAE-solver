namespace SolverCore
{
        ...
        where T : ITransposeLinearOperator, ILinearOperator
    {
        ...
        public IVector LMult(IVector vector, bool isUseDiagonal, DiagonalElement diagonalElement = DiagonalElement.One) => Matrix.LMultTranspose(vector, isUseDiagonal, diagonalElement);
